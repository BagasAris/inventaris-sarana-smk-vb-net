...
Public Class FInventaris
    ...
    End Sub
        ...
        Sub Simpan()
            ...
            str = "INSERT INTO tb_inventaris (id_inventaris, nama, kondisi, jumlah, id_jenis, tgl_register, id_ruang, kode_inventaris, id_petugas, keterangan) VALUES ('" & idInventarisTxt.Text & "','" & namaTxt.Text & "', '" & kondisiTxt.Text & "', '" & jumlahTxt.Text & "', '" & idJenisTxt.Text & "','" & tglRegister.Text & "','" & idRuangTxt.Text & "','" & kodeTxt.Text & "','" & idPetugasTxt.Text & "','" & keteranganTxt.Text & "')"
        ...
        Sub updateUser()
            Try
                Call koneksi()
                Dim str As String
            str = "UPDATE tb_inventaris SET id_inventaris = '" & idInventarisTxt.Text & "', nama = '" & namaTxt.Text & "', kondisi = '" & kondisiTxt.Text & "', jumlah ='" & jumlahTxt.Text & "', id_jenis ='" & idJenisTxt.Text & "', tgl_register ='" & tglRegister.Text & "', id_ruang ='" & idRuangTxt.Text & "', kode_inventaris ='" & kodeTxt.Text & "', id_petugas ='" & idPetugasTxt.Text & "', keterangan ='" & keteranganTxt.Text & "' WHERE id_inventaris = '" & idInventarisTxt.Text & "'"
