...
Public Class FPeminjaman
    ...
    Sub Simpan()
        ...
        Try
            ...
            str = "INSERT INTO tb_peminjaman (id_peminjaman, tgl_pinjam, tgl_kembali, status_peminjaman, id_pegawai) VALUES ('" & idpPeminjamanTxt.Text & "','" & tglPinjam.Value.ToString("yyyy-MM-dd") & "', '" & tglKembali.Value.ToString("yyyy-MM-dd") & "', '" & statusTxt.Text & "', '" & idPegawaiTxt.Text & "')"
    ...
    Sub updateUser()
        Try
            Call koneksi()
            Dim str As String
            str = "UPDATE tb_peminjaman SET id_peminjaman = '" & idpPeminjamanTxt.Text & "', tgl_pinjam = '" & tglPinjam.Value.ToString("yyyy-MM-dd") & "', tgl_kembali = '" & tglKembali.Value.ToString("yyyy-MM-dd") & "', status_peminjaman ='" & statusTxt.Text & "', id_pegawai ='" & idPegawaiTxt.Text & "' WHERE id_peminjaman = '" & idpPeminjamanTxt.Text & "'"
